...
int main()
{
	...
	printf("WELCOME TO ONLINE BANK MANAGEMENT SYSTEM\n\n");
	gotoxy(18, 5);

	printf("**********************************");
	gotoxy(25, 7);

	printf("DEVELOPER-Cheruku Manikanta, Ayush Raghuvganshi, Shreyash Singh, Kartikey Singh");
